...
map.getView().fit([12692997.881232, -88312.316662, 12800068.297518, -8686.066290], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analisis spasial Aksesibilitas Faskes: Integrasi Service Area dan OD Matrix Murung Raya Kalimantan Tengah</h2>';
        return titleElement;
    })(),
